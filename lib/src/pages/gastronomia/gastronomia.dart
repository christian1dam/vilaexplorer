...
class _GastronomiaPageState extends State<GastronomiaPage> {
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                if (isSearchActive)
                  Flexible(fit: FlexFit.loose, child: _buildSearchField()),
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final plato = platos[index] as Plato;
          return GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => DetallePlatillo(platoID: plato.platoId),
                ),
              );
            },
  ...
  Widget _buildGridView(List platos, GastronomiaService service) {
    return SizedBox(
      height: widget.boxConstraints!.maxHeight * 0.6,
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            onTap: () {
              Navigator.pushNamed(context, DetallePlatillo.route,
                  arguments: plato);
            },
