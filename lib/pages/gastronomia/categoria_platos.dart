...
const kContainerColor = Colors
    .white10; // Usamos white10 en lugar de withOpacity(0.1) para mejor legibilidad
    ...
    return Align(
      ...
      child: Container(
        height: MediaQuery.of(context).size.height *
            0.75, // Ajustamos la altura al 75% para dejar el mapa visible
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return _buildPlatoCard(context, 'Paella Valenciana',
  ...
  Widget _buildPlatoCard(BuildContext context, String name, String imagePath) {
    return Padding(
      ...
      child: GestureDetector(
        // Usamos GestureDetector para manejar el clic
        onTap: () {
          onPlatilloSelected(
              name); // Navegamos hacia la pantalla de detalle del platillo
        },
        child: Container(
          decoration: BoxDecoration(
            color: kContainerColor, // Color semi-transparente
            borderRadius:
                BorderRadius.circular(kBorderRadius), // Bordes redondeados
          ),
          child: Column(
            // Formato vertical
            children: [
  ...
  Widget _buildImage(String imagePath) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(
          kBorderRadius), // Borde redondeado para la imagen
      child: Image.asset(
        imagePath,
  ...
  Widget _buildTitle(String name) {
    return Padding(
      ...
      child: Text(
        name,
        style:
            kTitleTextStyle, // Aplicamos el estilo de texto definido en las constantes
      ),
    );
  }
}
